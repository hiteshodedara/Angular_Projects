...
export declare class NbIconComponent implements NbIconConfig, OnChanges, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NbIconComponent, "nb-icon", never, { "icon": "icon"; "pack": "pack"; "options": "options"; "status": "status"; "config": "config"; }, {}, never, never, false, never>;
}
