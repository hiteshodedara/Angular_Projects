...
function registerPrebuiltTheme(options) {
    return (0, utility_1.updateWorkspace)((workspace) => __awaiter(this, void 0, void 0, function* () {
...
function insertThemeImportInStyles(tree, stylesPath) {
    const recorder = tree.beginUpdate(stylesPath).insertLeft(0, theme_content_1.stylesContent);
...
function throwSCSSRequiredForCustomizableThemes() {
    throw new schematics_1.SchematicsException('No scss root found. Customizable theme requires scss to be enabled in the project.');
}
